...
grails.serverURL = "localhost:8090"
// The ACCEPT header will not be used for content negotiation for subscribedBy agents containing the following strings (defaults to the 4 major rendering engines)
